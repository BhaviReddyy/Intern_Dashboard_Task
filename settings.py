...
SECRET_KEY = 'django-insecure-g%3!jaag9h=9dldjow*z0aci5@cs*r8x8a7ls-wd5q5^*f$%n^'
...
INSTALLED_APPS = [
    ...
    'dashboard_module',  # <-- Add this line
...
ALLOWED_HOSTS = ['*']  # Allow all hosts temporarily for testing
